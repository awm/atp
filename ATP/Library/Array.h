...
*/
EXPORT unsigned int ATP_arrayLength(ATP_Array *p_array);
...
*/
EXPORT ATP_ValueType ATP_arrayGetType(ATP_Array *p_array, unsigned int p_index);
...
*/
EXPORT int ATP_arrayGetString(ATP_Array *p_array, unsigned int p_index, const char **p_value);
...
Returns:
    1 on success, 0 on failure.  In particular, if the entry does not exist or is of the wrong type then 0 will be returned.
*/
EXPORT int ATP_arrayGetUint(ATP_Array *p_array, unsigned int p_index, unsigned long long *p_value);
...
Returns:
    1 on success, 0 on failure.  In particular, if the entry does not exist or is of the wrong type then 0 will be returned.
*/
EXPORT int ATP_arrayGetInt(ATP_Array *p_array, unsigned int p_index, signed long long *p_value);
...
Returns:
    1 on success, 0 on failure.  In particular, if the entry does not exist or is of the wrong type then 0 will be returned.
*/
EXPORT int ATP_arrayGetDouble(ATP_Array *p_array, unsigned int p_index, double *p_value);
...
Returns:
    1 on success, 0 on failure.  In particular, if the entry does not exist or is of the wrong type then 0 will be returned.
*/
EXPORT int ATP_arrayGetBool(ATP_Array *p_array, unsigned int p_index, int *p_value);
...
Returns:
    1 on success, 0 on failure.  In particular, if the entry does not exist or is of the wrong type then 0 will be returned.
*/
EXPORT int ATP_arrayGetDict(ATP_Array *p_array, unsigned int p_index, ATP_Dictionary **p_value);
...
Returns:
    1 on success, 0 on failure.  In particular, if the entry does not exist or is of the wrong type then 0 will be returned.
*/
EXPORT int ATP_arrayGetArray(ATP_Array *p_array, unsigned int p_index, ATP_Array **p_value);
